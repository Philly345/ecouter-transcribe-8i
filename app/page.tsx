...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      {/* Hero Section */}
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-8 pt-20 pb-32 text-center space-y-8">
        ...
        <div className="flex items-center justify-center space-x-2 text-gray-400">
          ...
          <span className="text-sm">
            {getTranslatedText("Trusted by 10,000+ users worldwide")}
          </span>
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-8 pb-20">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Feature cards as in original */}
          <Card className="bg-white/5 border-white/10 hover:bg-white/10 transition-colors">
            <CardContent className="p-6">
              <Mic className="h-6 w-6 text-blue-400 mb-4 bg-blue-500/20 p-2 rounded-lg" />
          ...
          <Card className="bg-white/5 border-white/10 hover:bg-white/10 transition-colors">
            <CardContent className="p-6">
              <Users className="h-6 w-6 text-green-400 mb-4 bg-green-500/20 p-2 rounded-lg" />
          ...
          <Card className="bg-white/5 border-white/10 hover:bg-white/10 transition-colors">
            <CardContent className="p-6">
              <Zap className="h-6 w-6 text-purple-400 mb-4 bg-purple-500/20 p-2 rounded-lg" />
              <h3 className="text-xl font-semibold mb-2">Smart Summaries</h3>
              <p className="text-gray-400">
                AI‑generated summaries, key topics, and actionable insights
              </p>
            </CardContent>
          </Card>
          <Card className="bg-white/5 border-white/10 hover:bg-white/10 transition-colors">
            <CardContent className="p-6">
              <Clock className="h-6 w-6 text-yellow-400 mb-4 bg-yellow-500/20 p-2 rounded-lg" />
              <h3 className="text-xl font-semibold mb-2">Fast Processing</h3>
              <p className="text-gray-400">
                Get your transcripts in minutes, not hours. Optimized for speed
              </p>
            </CardContent>
          </Card>
          <Card className="bg-white/5 border-white/10 hover:bg-white/10 transition-colors">
            <CardContent className="p-6">
              <Shield className="h-6 w-6 text-red-400 mb-4 bg-red-500/20 p-2 rounded-lg" />
          ...
          <Card className="bg-white/5 border-white/10 hover:bg-white/10 transition-colors">
            <CardContent className="p-6">
              <Download className="h-6 w-6 text-cyan-400 mb-4 bg-cyan-500/20 p-2 rounded-lg" />
              <h3 className="text-xl font-semibold mb-2">Multiple Formats</h3>
              <p className="text-gray-400">Export in TXT, SRT, VTT, or JSON</p>
            </CardContent>
          </Card>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-8 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-400">
                Advanced AI transcription for professionals and businesses worldwide.
              </p>
            </div>
